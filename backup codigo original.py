...
bala = proyectil(10)
enemigo = enemigos(1,0,0,1,30,30)
...
font_2= pygame.font.SysFont("PIXEL.ttf",100)
texto_2 = font.render("GAME OVER", True,(blanco))
texto_recto_2 = texto.get_rect()
#lo centramos
texto_recto_2.center = (390,300)
...
while running :
	...
	if player.vida >0 :
		...
		#funcion de perseguir del enemigo
